...
pub fn compile(manifest: bool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (icon_filename, product_name) = match channel {
        "stable" => ("app-icon.ico", "Zedium"),
        "preview" => ("app-icon-preview.ico", "Zedium Preview"),
        "nightly" => ("app-icon-nightly.ico", "Zedium Nightly"),
        _ => ("app-icon-dev.ico", "Zedium Dev"),
    };
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "CompanyName", "Zedium\0"
            VALUE "LegalCopyright", "Copyright 2022 - 2025 Zed Industries, Inc. Zedium modifications Copyright 2026 Zedium contributors.\0"
        END
    END
    BLOCK "VarFileInfo"
    BEGIN
