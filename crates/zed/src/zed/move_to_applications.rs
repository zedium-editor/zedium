...
impl MoveToApplicationsRequest {
    ...
    async fn prompt(
        ...
        let response = cx
            .prompt(
                PromptLevel::Info,
                "Move Zedium to Applications?",
                Some(
                    "Zedium is running from a temporary location. Move it to Applications to finish installing it.",
                ),
                &[
                    PromptButton::ok("Yes"),
            ...
            0 => {
                ...
                if let Err(error) = move_to_applications(&self.app_path, cx).await {
                    ...
                    cx.prompt(
                        ...
                        "Failed to move Zedium to Applications",
        ...
        v_flex()
            ...
            .child(
                div()
                    ...
                    .child(Label::new("Installing Zedium…")),
            )
            .child(
                h_flex()
                    .w_full()
                    ...
                    .child(
                        v_flex()
                            .gap_1()
                            .child(Label::new("Moving Zedium to Applications"))
                            .child(
                                Label::new("Zedium will reopen when installation is complete.")
